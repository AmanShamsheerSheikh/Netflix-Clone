...
public class TrendingAdapter extends RecyclerView.Adapter<TrendingAdapter.MovieHolder> {
    private Context context;
    private ArrayList<Movie> movieList;
    private onMovieListener mOnMovieListener;
    public TrendingAdapter(Context context, ArrayList<Movie> movieList,onMovieListener OnMovieListener) {
    ...
    public class MovieHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            monMovieListener.onMovieClickTrending(getAdapterPosition());
        }
    }
    public interface onMovieListener{
        void onMovieClickTrending(int position);
    }
}
