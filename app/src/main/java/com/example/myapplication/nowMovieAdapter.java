...
public class nowMovieAdapter extends RecyclerView.Adapter<nowMovieAdapter.MovieHolder> {
    private Context context;
    private ArrayList<Movie> movieList;
    private onMovieListener mOnMovieListener;
    public nowMovieAdapter(Context context, ArrayList<Movie> movieList,onMovieListener OnMovieListener) {
