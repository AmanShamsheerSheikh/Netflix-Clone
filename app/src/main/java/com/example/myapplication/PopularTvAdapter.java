...
public class PopularTvAdapter extends RecyclerView.Adapter<PopularTvAdapter.MovieHolder> {
    private Context context;
    private ArrayList<Movie> movieList;
    private onMovieListener mOnMovieListener;
    public PopularTvAdapter(Context context, ArrayList<Movie> movieList,onMovieListener OnMovieListener) {
    ...
    public class MovieHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            monMovieListener.onMovieClickPopularTv(getAdapterPosition());
        }
    }
    public interface onMovieListener{
        void onMovieClickPopularTv(int position);
    }
}
